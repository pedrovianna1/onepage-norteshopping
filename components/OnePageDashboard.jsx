...
import { Upload, Download, TrendingUp, TrendingDown, ChevronDown, ArrowUp, ArrowDown } from "lucide-react";
      ...
      <div style={{
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 20 }}>
          <div>
            ...
            <div style={{ fontSize: 11, letterSpacing: "0.16em", color: C.inkDim, fontWeight: 600, marginTop: 10 }}>
              EQUIPE COMERCIAL · {d ? `${competenciaLabel(selected).mes} ${competenciaLabel(selected).ano}` : "—"}
            </div>
          </div>

          <div style={{ display: "flex", alignItems: "center", gap: 18 }}>
            <div style={{ textAlign: "right", fontFamily: "Calibri, 'Segoe UI', Arial, sans-serif" }}>
              <div style={{ fontSize: 20, fontWeight: 700, color: C.ink, letterSpacing: "0.02em" }}>
                {competenciaLabel(selected).mes}
              </div>
              <div style={{ fontSize: 7, color: C.inkDim, letterSpacing: "0.08em" }}>{competenciaLabel(selected).ano}</div>
            </div>
